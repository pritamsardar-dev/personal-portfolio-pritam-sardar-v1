// Actaul ref of the Project row form another projcet for you better understanding
export const pulmoAiProjectRow = {
  id: "project-row-pulmo-ai",
  title: "Pulmo AI: Respiratory Disease Classification from Lung Audio",
  enabled: true,
  domain: "project",
  order: 1,
  topOrder: 1,
  ...
  secondaryCategories: [
    { key: "healthcare", label: "Healthcare Tech" },
    ...
    },
    {
      ...
      data: {
        heading: {
          ...
          text: "Pulmo AI: Respiratory Disease Classification from Lung Audio",
          icon: {
