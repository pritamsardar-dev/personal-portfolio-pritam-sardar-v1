...
const Avatar = ({ variant = "default", image = null, name = "", className = "", ...props }) => {
  ...
  const classes = clsx(baseAvatar, variantConfig.baseClasses, className);

  return (
    <div
      className={classes}
      style={{ backgroundColor: image ? "transparent" : bgColor }}
      {...props}
    >
      {image ? (
