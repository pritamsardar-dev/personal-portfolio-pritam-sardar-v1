...
import { projectsPageLoadingStructure } from "../../loading/pageLoadingStructures/projectsPageLoading.structure";
...
const ProjectsPageContainer = () => {
  ...
  useEffect(() => {
    const fetchPage = async () => {
      try {
        const pageRes = await getPageBySlug("projects");
    ...
    <PageRenderer
      data={
        isInitialLoading || !apiData.page
          ? {
            page: projectsPageLoadingStructure,
          }
          : apiData
      }
